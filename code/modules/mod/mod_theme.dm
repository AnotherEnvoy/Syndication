...
/datum/mod_theme/magnate
	name = "commando"
	desc = "A fancy, very protective suit for the Syndicate's captain equivalents. Shock, fire and acid-proof while also having a large capacity and high speed."
	extended_desc = "They say it costs four hundred thousand credits to run this MODsuit... for twelve seconds. \
		The Commando suit is designed for protection, comfort, and luxury for Nanotrasen Captains. \
		The onboard air filters have been preprogrammed with an additional five hundred different fragrances that can \
		be pumped into the helmet, all of highly-endangered flowers. A bespoke Cybersun mechanical clock has been placed \
		in the wrist, and the Commando package comes with carbon-fibre cufflinks to wear underneath. \
		...
		have been employed for speed. The resemblance to a Gorlex Marauder helmet is not coincidental."
