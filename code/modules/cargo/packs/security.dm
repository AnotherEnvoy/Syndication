...
/datum/supply_pack/security/forensics
	...
	desc = "Stay hot on the criminal's heels with Gorlex's forensics set. Contains a forensics scanner, six evidence bags, camera, tape recorder, white crayon, and of course, a fedora. Requires Security access to open."
	cost = 1800
...
/datum/supply_pack/security/justiceinbound
	...
	desc = "oh golly jee i sure do love stealing shit from nanotrasen, don't you? Requires Security access to open."
